...
void main() {
	...
	// project from triangles not facing light
	if( dot(normal, lightDir) < 0 ) {
		...
		lightDir = (normalize(Pos[1] - gLightPos));
		gl_Position = gView * vec4((Pos[1]), 1.0);
		EmitVertex();
