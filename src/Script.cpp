...
void Script::exposeEngine() {
	luabridge::getGlobalNamespace(lua)
		...
		.addFunction("getAnyKeyStatus", &Engine::getAnyKeyStatus)
		.addFunction("getLastInputOfAnyKind", &Engine::getLastInputOfAnyKind)
...
void Script::exposeFrame() {
	luabridge::getGlobalNamespace(lua)
		...
		.addFunction("isPressed", &Widget::isPressed)
		.addFunction("isHighlighted", &Widget::isHighlighted)
		.addFunction("isSelected", &Widget::isSelected)
		.addFunction("isDisabled", &Widget::isDisabled)
		.addFunction("isInvisible", &Widget::isInvisible)
		.addFunction("getHighlightTime", &Widget::getHighlightTime)
		.addFunction("getOwner", &Widget::getOwner)
		.addFunction("getWidgetRight", &Widget::getWidgetRight)
		.addFunction("getWidgetDown", &Widget::getWidgetDown)
		.addFunction("getWidgetLeft", &Widget::getWidgetLeft)
		.addFunction("getWidgetUp", &Widget::getWidgetUp)
		...
		.addFunction("setSelected", &Widget::setSelected)
		.addFunction("setDisabled", &Widget::setDisabled)
		.addFunction("setInvisible", &Widget::setInvisible)
		.addFunction("setOwner", &Widget::setOwner)
		.addFunction("setWidgetRight", &Widget::setWidgetRight)
		.addFunction("setWidgetDown", &Widget::setWidgetDown)
		.addFunction("setWidgetLeft", &Widget::setWidgetLeft)
		.addFunction("setWidgetUp", &Widget::setWidgetUp)
	...
	luabridge::getGlobalNamespace(lua)
		.deriveClass<Frame, Widget>("Frame")
		...
		.addFunction("clearEntries", &Frame::clearEntries)
	...
	luabridge::getGlobalNamespace(lua)
		.deriveClass<Field, Widget>("Field")
